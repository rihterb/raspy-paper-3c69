...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/platobot
```

A live public deployment of this template is available at [https://platobot.templates.workers.dev](https://platobot.templates.workers.dev)
